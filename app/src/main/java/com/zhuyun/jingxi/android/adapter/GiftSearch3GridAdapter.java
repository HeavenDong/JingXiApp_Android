 ...
 */
public class GiftSearch3GridAdapter extends BaseAdapter {
    ...
    public GiftSearch3GridAdapter(GiftFreeSelectActivity context, List<GiftSearchBean> lists) {
...
//                Log.e("haifeng","点击 ---------------------------");
                ...
                GiftSearch3GridAdapter.this.notifyDataSetChanged();
            }
        });
