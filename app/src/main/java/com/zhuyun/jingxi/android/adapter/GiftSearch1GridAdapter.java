 ...
 */
public class GiftSearch1GridAdapter extends BaseAdapter {
    ...
    public GiftSearch1GridAdapter(GiftFreeSelectActivity context, List<GiftSearchBean> lists) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.publishwish_item_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyLogs.e("haifeng","价格点击");
                context.setEditUnFocus(1);
...
//                Log.e("haifeng","点击 ---------------------------");
                ...
                GiftSearch1GridAdapter.this.notifyDataSetChanged();
            }
        });
