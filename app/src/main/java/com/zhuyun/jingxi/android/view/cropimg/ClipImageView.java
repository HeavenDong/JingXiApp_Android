package com.zhuyun.jingxi.android.view.cropimg;
...
/**
 * 用于方形图-----缩放裁剪的自定义ImageView底部视图
 * Created by jiangxiangfei on 2015/12/16
 */
public class ClipImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener{
    ...
    public Bitmap clip(){
        ...
        MyLogs.e("jxf", "底层bitmap大小打印" + (bitmap.getRowBytes() * bitmap.getHeight()));
