 ...
 */
public class GiftSearch4GridAdapter extends BaseAdapter {
    ...
    public GiftSearch4GridAdapter(GiftFreeSelectActivity context, List<GiftSearchBean> lists) {
...
//                Log.e("haifeng","点击 ---------------------------");
                ...
                GiftSearch4GridAdapter.this.notifyDataSetChanged();
            }
        });
