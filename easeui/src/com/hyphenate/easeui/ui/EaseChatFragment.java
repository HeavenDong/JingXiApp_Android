    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {//单聊
            ...
            if(EaseUserUtils.getUserInfo(toChatUsername) != null){
                ...
                Log.e("haifeng","nick="+EaseUserUtils.getUserInfo(toChatUsername).getNick());
                Log.e("haifeng","Avatar="+EaseUserUtils.getUserInfo(toChatUsername).getAvatar());
                Log.e("haifeng","Username="+EaseUserUtils.getUserInfo(toChatUsername).getUsername());

                Log.e("haifeng","我的 nick="+EaseUserUtils.getUserInfo("73278a4a86960eeb576a8fd4c9ec6997113").getNick());
                Log.e("haifeng","Avatar="+EaseUserUtils.getUserInfo("73278a4a86960eeb576a8fd4c9ec6997113").getAvatar());
                Log.e("haifeng","Username="+EaseUserUtils.getUserInfo("73278a4a86960eeb576a8fd4c9ec6997113").getUsername());
